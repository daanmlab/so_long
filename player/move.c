...
/*   Updated: 2023/12/09 18:30:44 by dabalm           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	do_move_up(t_game *game)
{
	if (can_move_up(game))
    {
        kill_coll(game, &(game->player->hitbox->topleft), &(game->player->hitbox->topright));
	    use_exit(game);
		game->player->move++;
    }
}
...
void	do_move_down(t_game *game)
{
    ...
    {
	    use_exit(game);
        kill_coll(game, &(game->player->hitbox->bottomleft), &(game->player->hitbox->bottomright));
	    game->player->move++;
    }
}
...
void	do_move_right(t_game *game)
{
    ...
    {
	    use_exit(game);
        kill_coll(game, &(game->player->hitbox->bottomright), &(game->player->hitbox->topright));
	    game->player->move++;
    }
}
...
void	do_move_left(t_game *game)
{
    ...
    {
	    use_exit(game);
        kill_coll(game, &(game->player->hitbox->topleft), &(game->player->hitbox->bottomleft));
	    game->player->move++;
    }
}
